...
export default function CustomHeader() {
  ...
  const handleSelection = (key) => {
    if (!isLoggedIn) {
      ...
      if (key === "/myOrders" || key === "/myProfile" || key === "/logout") {
        setSelectedKeys([]);
        setQuerry("");
  ...
  const handleSearchQuerry = (query) => {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTJquCk6WMyFlDE39BYkh0_gQW4sYyyK2xyLDPrAC0paA&s"
          alt="Logo"
      ...
      <Input.Search
        ...
        onSearch={handleSearchQuerry} // Handle search functionality
